...
func (manager *syncerManager) garbageCollectNEG() error {
	...
	// TODO: do not lock the syncer manager during NEG deletion.
	manager.mu.Lock()
	defer manager.mu.Unlock()
...
// decodeSyncerKey decodes a service namespace, name and targetPort
func decodeSyncerKey(key string) (string, string, string) {
